...
import { roleFor, inferPotentielResidentiel } from "./role-evaluation.mjs";
...
export async function lookup(query) {
  ...
  // Potentiel résidentiel à partir des codes CUBF
  const potentiel = role.trouve
    ? inferPotentielResidentiel(role.cubf_codes ?? [], role.nombre_logements)
    : null;
